...
class NotificationActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnBackNotif = findViewById<ImageButton>(R.id.btnBackNotif)
        ...
        val notifikasiList = listOf(
            ...
            Notifikasi("Pengingat 🌸", "Anggrek Bulan perlu dipupuk minggu ini.", "Kemarin", "Pengingat", android.R.drawable.ic_dialog_info),
